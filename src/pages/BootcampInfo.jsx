              ...
              <div style={{ opacity: 1, transition: 'opacity 0.3s ease', display: 'flex', flexDirection: 'column', height: '100%' }}>
                          ...
                          return (
                            <>
                                  ...
                                  <div key={mod.moduleId} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#f5f5f5', padding: '15px', borderRadius: '8px', border: '1px solid #e0e0e0', flexWrap: 'wrap', gap: '10px' }}>
                                    <div>
                                      <strong style={{ 
                                        ...
                                        display: 'block', 
                                        fontSize: '1.1rem',
                                        filter: (expandedCard.num !== '1' && expandedCard.num !== 1 && expandedCard.num !== '2' && expandedCard.num !== 2 && expandedCard.num !== '3' && expandedCard.num !== 3 && expandedCard.num !== '4' && expandedCard.num !== 4 && expandedCard.num !== '5' && expandedCard.num !== 5 && expandedCard.num !== '6' && expandedCard.num !== 6 && expandedCard.num !== '🏆') ? 'blur(5px)' : 'none',
                                        userSelect: (expandedCard.num !== '1' && expandedCard.num !== 1 && expandedCard.num !== '2' && expandedCard.num !== 2 && expandedCard.num !== '3' && expandedCard.num !== 3 && expandedCard.num !== '4' && expandedCard.num !== 4 && expandedCard.num !== '5' && expandedCard.num !== 5 && expandedCard.num !== '6' && expandedCard.num !== 6 && expandedCard.num !== '🏆') ? 'none' : 'auto'
                                      }}>
                                        {mod.moduleName}
                                      </strong>
                                      ...
                                      {isVerified ? (
                                        <div style={{ display: 'flex', alignItems: 'center', color: '#2ea043', fontWeight: 'bold' }}>
                                          ...
                                          <button 
                                            ...
                                            disabled={expandedCard.num !== '1' && expandedCard.num !== 1 && expandedCard.num !== '2' && expandedCard.num !== 2 && expandedCard.num !== '3' && expandedCard.num !== 3 && expandedCard.num !== '4' && expandedCard.num !== 4 && expandedCard.num !== '5' && expandedCard.num !== 5 && expandedCard.num !== '6' && expandedCard.num !== 6 && expandedCard.num !== '🏆'}
                                            style={{ 
                                              background: (expandedCard.num !== '1' && expandedCard.num !== 1 && expandedCard.num !== '2' && expandedCard.num !== 2 && expandedCard.num !== '3' && expandedCard.num !== 3 && expandedCard.num !== '4' && expandedCard.num !== 4 && expandedCard.num !== '5' && expandedCard.num !== 5 && expandedCard.num !== '6' && expandedCard.num !== 6 && expandedCard.num !== '🏆') ? '#ccc' : '#1d1c1c', 
                                              color: (expandedCard.num !== '1' && expandedCard.num !== 1 && expandedCard.num !== '2' && expandedCard.num !== 2 && expandedCard.num !== '3' && expandedCard.num !== 3 && expandedCard.num !== '4' && expandedCard.num !== 4 && expandedCard.num !== '5' && expandedCard.num !== 5 && expandedCard.num !== '6' && expandedCard.num !== 6 && expandedCard.num !== '🏆') ? '#666' : '#fff', 
                                              padding: '8px 16px', 
                                              borderRadius: '6px', 
                                              border: 'none', 
                                              cursor: (expandedCard.num !== '1' && expandedCard.num !== 1 && expandedCard.num !== '2' && expandedCard.num !== 2 && expandedCard.num !== '3' && expandedCard.num !== 3 && expandedCard.num !== '4' && expandedCard.num !== 4 && expandedCard.num !== '5' && expandedCard.num !== 5 && expandedCard.num !== '6' && expandedCard.num !== 6 && expandedCard.num !== '🏆') ? 'not-allowed' : 'pointer', 
                                              fontWeight: 'bold' 
                                            }}
                                          >
                                            Verify Badge
                              ...
                              <div style={{ marginTop: '20px', borderTop: '2px dashed #ccc', paddingTop: '20px' }}>
                                ...
                                {expandedCard.num === '1' || expandedCard.num === 1 || expandedCard.num === '2' || expandedCard.num === 2 || expandedCard.num === '3' || expandedCard.num === 3 || expandedCard.num === '4' || expandedCard.num === 4 || expandedCard.num === '5' || expandedCard.num === 5 || expandedCard.num === '6' || expandedCard.num === 6 || expandedCard.num === '🏆' ? (
                                  <button 
                ...
                <div style={{ marginTop: 'auto', paddingTop: '2rem', paddingBottom: '1rem', borderTop: '2px solid rgba(0,0,0,0.1)' }}>
                  {expandedCard.num === '1' || expandedCard.num === 1 ? (
                    ...
                    <a href="https://stdntpartners-my.sharepoint.com/:v:/g/personal/abhishek_agrawal_studentambassadors_com/IQAtLOrrSUrSQKmdV8_-3r1bAW_8tdVe5vUSQuPkbF5w9pg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=Gsd99I" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
                      <button className="mythical-hero-btn" style={{ padding: '16px 32px', width: '100%', fontSize: '1.2rem', border: 'none', cursor: 'pointer', color: '#ffffff', background: 'linear-gradient(135deg, #d83b01, #a32a00)' }}>
                        🎥 Session Recording
                      </button>
                    </a>
                  ...
                  ) : expandedCard.num === '5' || expandedCard.num === 5 ? (
                    <a href="https://stdntpartners-my.sharepoint.com/:v:/g/personal/abhishek_agrawal_studentambassadors_com/IQD99vuF07WQSoKEWDxy44Y3AfEazuI66-uC7OdvppHfxzk?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=HH1vIT" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
                      <button className="mythical-hero-btn" style={{ padding: '16px 32px', width: '100%', fontSize: '1.2rem', border: 'none', cursor: 'pointer', color: '#ffffff', background: 'linear-gradient(135deg, #d83b01, #a32a00)' }}>
                        🎥 Session Recording
                      </button>
                    </a>
                  ) : expandedCard.num === '6' || expandedCard.num === 6 ? (
                    <a href="https://stdntpartners-my.sharepoint.com/:v:/g/personal/abhishek_agrawal_studentambassadors_com/IQBLE6euw2raQbiWu1rnKl7XAfFye_-n-WKvKDiytnT0e0E?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=BozlLU" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
                      <button className="mythical-hero-btn" style={{ padding: '16px 32px', width: '100%', fontSize: '1.2rem', border: 'none', cursor: 'pointer', color: '#ffffff', background: 'linear-gradient(135deg, #d83b01, #a32a00)' }}>
                        🎥 Session Recording
                      </button>
                    </a>
